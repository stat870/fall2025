...
Swine nutritionists are studying the effect of dietary treatments on the \% of fecal dry matter. 
...
One pig was observed at 3 points in time. 
...
After all, it's hard to find rooms that fit 270 pens!!

Consider an experiment with the same treatments, same number of EUs, but ran in 3 different rooms with 90 pens each. 
Each room has 15 pens of each dietary treatment.  
...
- Standard errors for the means: $se(\hat\mu_{ij}) = \sqrt{\frac{\sigma^2_e + \sigma^2_b}{gb}}$ 
- Standard errors for comparisons: $se(\mu_{\cdot j}-\mu_{\cdot j'}) = \sqrt{\frac{2 \sigma^2_e }{b}}$ 
...
- Read Chapter 2 in Stroup el at. (2024), particularly the "What Would Fisher Do" ANOVA shells. 
