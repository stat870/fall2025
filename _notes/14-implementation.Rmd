...
- The equations above can be rewritten into making it very obvious that 
  - Hessian matrix must be positive-definite 
  - 
- For more details check out [Bates et al., 2015](https://cran.r-project.org/web/packages/lme4/vignettes/lmer.pdf) 
